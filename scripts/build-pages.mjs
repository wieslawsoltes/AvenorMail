...
await build({entryPoints:[resolve(root,'public/app.js'),resolve(root,'public/benchmark.js'),resolve(root,'public/search-worker.js')],outdir:out,bundle:true,format:'esm',platform:'browser',target:['es2022'],minify:true,legalComments:'linked',sourcemap:true});
